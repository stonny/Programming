...
{
    /// <summary>
    /// This class target is to define the Main Player Logic - Adding Shots, Updating and Drawing shots
    /// </summary>
    class PlayerLogic
    {
        // Method that adds Attack so more than one attack can be shot at the moment
