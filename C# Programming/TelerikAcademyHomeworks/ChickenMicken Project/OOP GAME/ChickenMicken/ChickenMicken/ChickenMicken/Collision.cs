...
namespace ChickenMicken
{
    static class Collision
    {
        ...
        public static void CollisionPlayerAttacksToEnemy(ContentManager Content, List<PlayerAttack> spaceShipAttacks, List<Enemy> chickens, List<Explosion> explosions, Player spaceShip)
        {
        ...
        public static void CollisionPlayerToEnemy(ContentManager Content, Player spaceShip, List<Enemy> chickens, List<Explosion> explosions)
        {
        ...
        public static void CollisionEnemychickenAttacksToPlayer(ContentManager Content, Player spaceShip, List<EnemyAttack> chickenAttacks, List<Explosion> explosions)
        {
